...
<br>
    ...
    <div class = "container-fluid"><h2 style = "color : blue"><center>Biodata</center></h2></div>
    <div class = "container">
    <div class = "row">
    <div class = "col-md-6">
    ...
    <td><button class = "btn btn-outline-primary"><a href="show.php?id=<?php echo $data['id']; ?>&aksi=show" style = "text-decoration: none; color:black">Show</a></button>
        ...
        <button class = "btn btn-outline-danger"<a href="proses.php?id=<?php echo $data['id'];?>&aksi=delete" onclick="return confirm('Apakah anda yakin mau menghapusdata ini?');"style = "text-decoration: none; color: black">Delete</a></button>
    </td>
    </tr>
